<footer
	class="max-w-screen-md mx-auto px-5 py-8 border-t flex flex-col md:flex-row gap-6 md:gap-0 justify-center md:justify-between items-center"
>
	<p class="text-center md:text-left">
		© 2024 <span class="text-lime-600 font-medium">Muhammad Hafid K</span>. All rights reserved.
	</p>
