<header class="bg-neutral-50">
	<div class="mx-auto max-w-2xl px-6 pt-6 md:pt-12">
		<a href="/" class="text-lg font-semibold hover:text-violet-700">Muhammad Hafid K</a>
		<nav class="mt-1 flex items-center gap-4 text-base">
