...
<div class="">
	<div class="">
		...
		<p class="mt-2 text-3xl font-semibold">
			Muhammad <span class="text-violet-700">Hafid</span> Khoirul
		</p>
		<p class="mt-2">
			Software engineer based in Bogor, Indonesia. I am currently working as a backend engineer at <a
				href="https://www.qontak.com"
				class="text-violet-700 hover:text-violet-800">Qontak</a
			>.
		</p>
		<p class="mt-6">
			Outside of development, I take photos, write articles, plant my own food, and play badminton.
			While you are here, you can learn more <a
				href="/about"
				class="text-violet-700 hover:text-violet-800">about me</a
			>, read <a href="/blog" class="text-violet-700 hover:text-violet-800">my blog</a>, or watch
			<a
				href="https://www.youtube.com/@muhammadhafidk"
				class="text-violet-700 hover:text-violet-800">my videos</a
			>.
		</p>
	</div>
	<div class="mt-6">
