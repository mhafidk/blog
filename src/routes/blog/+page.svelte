...
<div class="">
	...
	<input
		...
		class="mt-6 w-full rounded border border-neutral-400 p-2 placeholder-neutral-400 focus:border-violet-600 focus:ring focus:ring-violet-400 focus:outline-none"
	/>
