...
<div class="">
  ...
  <div class="flex flex-col">
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/determinan-dan-invers-matriks#determinan-matriks">Determinan Matriks</a>
    <a class="pl-6 text-lime-600 hover:text-lime-700" href="/smambo/materi/determinan-dan-invers-matriks#determinan-matriks-2x2">Determinan Matriks 2x2</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/determinan-dan-invers-matriks#invers-matriks">Invers Matriks</a>
		<a class="pl-6 text-lime-600 hover:text-lime-700" href="/smambo/materi/determinan-dan-invers-matriks#invers-matriks-2x2">Invers Matriks 2x2</a>
  </div>
</div>
