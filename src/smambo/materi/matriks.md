...
<div class="">
  ...
  <div class="flex flex-col">
    ...
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/matriks#kesamaan-dua-matriks">Kesamaan Dua Matriks</a>
		<a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/matriks#operasi-matriks">Operasi Matriks</a>
		<a class="text-lime-600 hover:text-lime-700 pl-4" href="/smambo/materi/matriks#penjumlahan-matriks">Penjumlahan Matriks</a>
		<a class="text-lime-600 hover:text-lime-700 pl-4" href="/smambo/materi/matriks#pengurangan-matriks">Pengurangan Matriks</a>
		<a class="text-lime-600 hover:text-lime-700 pl-4" href="/smambo/materi/matriks#perkalian-matriks">Perkalian Matriks</a>
		<a class="text-lime-600 hover:text-lime-700 pl-8" href="/smambo/materi/matriks#perkalian-dengan-skalar">Perkalian Dengan Skalar</a>
		<a class="text-lime-600 hover:text-lime-700 pl-8" href="/smambo/materi/matriks#perkalian-dua-matriks">Perkalian Dua Matriks</a>
  </div>
</div>
