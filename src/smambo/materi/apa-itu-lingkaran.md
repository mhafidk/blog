...
<div class="">
  ...
  <div class="flex flex-col">
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/apa-itu-lingkaran#definisi-lingkaran">Definisi Lingkaran</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/apa-itu-lingkaran#bagian-bagian-lingkaran">Bagian-Bagian Lingkaran</a>
  </div>
</div>
