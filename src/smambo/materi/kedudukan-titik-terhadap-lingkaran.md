...
<div class="">
  ...
  <div class="flex flex-col">
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/kedudukan-titik-terhadap-lingkaran#titik-a(x%2Cy)a(x%2Cy)a(x%2Cy)-di-dalam-lingkaran">Titik $A(x,y)$ di Dalam Lingkaran</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/kedudukan-titik-terhadap-lingkaran#titik-a(x%2Cy)a(x%2Cy)a(x%2Cy)-pada-lingkaran">Titik $A(x,y)$ Pada Lingkaran</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/kedudukan-titik-terhadap-lingkaran#titik-a(x%2Cy)a(x%2Cy)a(x%2Cy)-di-luar-lingkaran">Titik $A(x,y)$ di Luar Lingkaran</a>
  </div>
</div>
