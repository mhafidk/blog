...
<div class="">
  ...
  <div class="flex flex-col">
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/busur-lingkaran#busur">Busur</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/busur-lingkaran#tali-busur">Tali Busur</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/busur-lingkaran#sudut-pusat">Sudut Pusat</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/busur-lingkaran#hubungan-panjang-busur-lingkaran-dengan-keliling-lingkaran">Hubungan Panjang Busur Lingkaran Dengan Keliling Lingkaran</a>
  </div>
</div>
