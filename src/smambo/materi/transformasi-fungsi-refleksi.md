...
<div class="">
  ...
  <div class="flex flex-col">
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/transformasi-fungsi-refleksi#apa-itu-transformasi-fungsi%3F">Apa itu Transformasi Fungsi?</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/transformasi-fungsi-refleksi#transformasi-fungsi---refleksi">Transformasi Fungsi - Refleksi</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/transformasi-fungsi-refleksi#refleksi-horizontal-atau-terhadap-sumbu-yyy">Refleksi Horizontal atau Terhadap Sumbu $y$</a>
    <a class="text-lime-600 hover:text-lime-700" href="/smambo/materi/transformasi-fungsi-refleksi#refleksi-vertikal-atau-terhadap-sumbu-xxx">Refleksi Vertikal atau Terhadap Sumbu $x$</a>
  </div>
</div>
